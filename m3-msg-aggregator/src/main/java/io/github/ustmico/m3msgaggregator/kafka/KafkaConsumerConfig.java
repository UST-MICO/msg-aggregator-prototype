package io.github.ustmico.m3msgaggregator.kafka;

import io.cloudevents.CloudEvent;
import io.github.ustmico.m3msgaggregator.AggregatorMessageListener;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, CloudEvent>> kafkaListenerContainerFactory() {
    ...
    @Bean
    public AggregatorMessageListener receiver() {
        return new AggregatorMessageListener();
    }
}
